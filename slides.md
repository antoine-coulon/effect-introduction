...
Antoine Coulon - 14/04/23 @ Aware talks

---

## Outcomes you can expect from the presentation
...
Unfortunately when running the code our program crash: `Error at <anonymous>`
...
- Eagerly executed, hence is impure, referentially-opaque, running computation (already a value).
